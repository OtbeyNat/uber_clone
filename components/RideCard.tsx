...
const RideCard = ({ ride } : { ride: Ride }) => {
    ...
    return (
        <View className="flex flex-row items-center justify-center bg-white rounded-lg shadow-sm shadow-neutral-300 mb-3 elevation">
            <View className="flex flex-col items-center justify-center p-3">
                ...
                <View className="flex flex-row items-center justify-between">
                    ...
                    <View className="flex flex-col mx-5 gap-y-5 flex-1">
                        <View className="flex flex-row items-center gap-x-2">
                            ...
                            numberOfLines={1}>{ride.origin_address}</Text>
                        </View>
                        <View className="flex flex-row items-center gap-x-2">
                            <Image
                            ...
                            />
                            <Text className="text-md font-JakartaMedium"
                            numberOfLines={1}>{ride.destination_address}</Text>
                        </View>
                    </View>
                </View>
                ...
                <View className="flex flex-col w-full mt-5 bg-general-500 rounded-lg p-3 items-start justify-center">
                    ...
                    <View className="flex flex-row items-center w-full justify-between mb-5">
                        ...
                        <Text className={`text-md capitalize font-JakartaMedium text-gray-500 ${ride.payment_status === 'paid' ? 'text-green-500' : 'text-red-500'}`}>
                            {ride.payment_status}
                        </Text>
                    </View>
